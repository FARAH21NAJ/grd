...
$documentation=$_POST["documentation"];
  ...
  $sql = "INSERT INTO patient_reviews1 (patient_name,patient_care_rating, rehabilitation_rating ,exercise_rating,mobility_rating,communication_rating,documentation_rating ) VALUES ('$patientName','$patientCareRating', '$rehabilitationRating' ,' $exercise','$mobility','$communication',' $documentation')";
